...
let assert_bool_list_equal =
  assert_equal
    ~printer:(string_of_list string_of_bool)
    ~cmp:(List.compare Bool.compare)

let assert_bool_list_option_equal =
  assert_equal
    ~printer:(string_of_option (string_of_list string_of_bool))
    ~cmp:(Option.compare (List.compare Bool.compare))
